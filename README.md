...
`lingkar_kepala`, `jumlah_saudara_kandung`) maupun lewat **label**nya, dan kotak
«Jarak rumah ke sekolah» memakai XPath dari skrip sekolah dengan cadangan berbasis label.
